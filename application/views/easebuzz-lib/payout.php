<?php
    ...
    *
    */
    function get_payout_details_by_date($params, $merchant_key, $salt, $env){
    ...
    *
    */
    function _payout($params, $merchant_key, $salt, $env){
        ...
        // email validation
        $email_validation = _emailValidation($postedArray['merchant_email']);
