                ...
                <div class="row">
                    ...
                    <?php $k=100; foreach($searched_subfaq as $row) { ?>
                          ...
                          <?php  }else { ?>
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
                                <!-- main panel -->
                                <?php  $i=1; $j=50; foreach($tutor_faq as $row) { ?>
                                <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <!-- sub panel -->
                                             ...
                                             <div class="panel-group" id="accordion<?=$i?>">
                                                <?php $sub_faq=$this->db->where(array('tutor_status'=>1,'faq_id'=>$row->id))->order_by('priority','asc')->get('sub_faq')->result();  foreach($sub_faq as $sub_faq1) { ?>
                                                <div class="panel">
                            ...
                            <?php $i++; } ?>
                                ...
                                <?php $k=100; foreach($tutor_subfaq as $row) { ?>
                                <div class="panel">
                                    <div class="panel-heading" role="tab" id="heading<?=$k?>">
                                        <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$k?>" aria-expanded="true" aria-controls="collapse<?=$k?>" class="collapsed"><?= $row->question;?></a>
