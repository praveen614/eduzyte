...
<div>
 ...
 <table width="500" border="1" align="center" cellpadding="0" cellspacing="0" style="border-color:#0076BE;bgcolor:#FFFFFF">
      <tbody>
        <tr>
        ...
        <tr>
          <td height="50"><table width="95%" border="0" align="center" cellpadding="5" cellspacing="2">
            ...
            <tr>
              <td align="left"><span style="color: #F68428">Congratulations! your account successfully created</span></td>
            </tr>
            <tr><td>Mr.<?=$first_name." ".$last_name?></td></tr>
			<tr><td>
					 user name : <?=$email?><br>         
