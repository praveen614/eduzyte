<?php 
$edit_data		=	$this->db->get_where('student_personal_profile' , array('student_id' => $param2) )->row();
...
<table width="500" border="0" align="center" cellpadding="5">
			...
			<tr>
                <td align="left"><b>Profile:</b></td>
				 ...
				 <img src="<?php echo base_url('uploads/student_profile/').$edit_data->profile_image;?>" height="80px" width="80px"><?php }?></td>
            </tr>
			...
			<tr>
				<td align="left" valign="top"><b>Address 2:</b></td>
				<td><?= $edit_data->address_2?></td>
			</tr>
			<tr>
