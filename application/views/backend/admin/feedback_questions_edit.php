        ...
        <br>
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/cms_page/feedback_questions/update/'.$data->id, array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <textarea class="form-control" rows="3" name="question" value=""><?= $data->question?> </textarea>
                                </div>
                            </div> 
