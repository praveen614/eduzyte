<a href="<?php echo base_url();?>admin/live_classes/demo_class/add" 
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td>TutorID : <?= $row->tutor_id;?><br>
							 ...
							 <td><?= $row->class_id;?></td>
                            <td style="max-width:400px;word-break:break-all;"><?= $row->class_link;?></td>  
                            <td>Fee per Hour: <?=$row->fee_hour?> <br>
                                Total Fee: <?=$row->total_fee?><br>
                                classID: <?=$row->class_id?>
                            </td>
							<td><a class="btn btn-success" target="_blank" href="<?php echo base_url();?>admin/live_classes/demo_class_student/<?php echo $row->class_id;?>"> VIEW</a></td>
                          <!--  <td>
