            ...
            <a href="<?php echo base_url();?>admin/cms_page/faq/add" 
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                        	<a href="<?php echo base_url();?>admin/cms_page/faq/edit/<?php echo $row->id;?>" >
                                       ...
                                       <li>
                                        	<a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/cms_page/faq/delete/<?php echo $row->id;?>');">
