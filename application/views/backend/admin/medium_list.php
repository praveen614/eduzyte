            ...
            <a href="<?php echo base_url();?>admin/course_page/medium/add" 
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                          <a href="<?php echo base_url();?>admin/course_page/medium/edit/<?php echo $row->id;?>" >
                                       ...
                                       <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/course_page/medium/delete/<?php echo $row->id;?>');">
