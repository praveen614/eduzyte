...
<div class="row">
    <div class="col-md-12">
      ...
      <table class="table table-bordered datatable" id="table_export">
          <thead>
              <tr>
                  <th width="80"><div><?php echo ucfirst('id_no');?></div></th>
                  <th width="80"><div><?php echo ucfirst('photo');?></div></th>
                  <th><div><?php echo ucfirst('name');?></div></th>
                  <th class="span3"><div><?php echo ucfirst('address');?></div></th>
                  <th><div><?php echo ucfirst('email');?></div></th>
                  ...
                  <td>
                      ...
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                              ...
                              <li>
                                  <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/student_id/<?php echo $row['student_id'];?>');">
                                      <i class="entypo-vcard"></i>
                                      <?php echo ucfirst('generate_id');?>
                                  </a>
                              </li>
