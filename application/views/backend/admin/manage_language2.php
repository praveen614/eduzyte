                    	...
                    	<tr>
                        	...
                        	<td>
                            	<a href="<?php echo base_url();?>index.php/admin/manage_language/edit_phrase/<?php echo $field;?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo ucfirst('edit_phrase');?>" class="btn btn-blue">
                    ...
                    <?php echo form_open(base_url().'index.php/admin/manage_language/add_phrase/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo ucfirst('phrase');?></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo ucfirst('add_phrase');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
			</div>
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'index.php/admin/manage_language/add_language/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo ucfirst('language');?></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo ucfirst('add_language');?></button>
                        </div>
                    <?php echo form_close();?> 
                </div>
			</div>
