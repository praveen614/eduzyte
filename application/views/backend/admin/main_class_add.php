    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/live_classes/main_class/insert', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>

                        <div class="form-group">
                                <label class="col-sm-3 control-label">Main Class ID</label>
                                <div class="col-sm-5">
				  ...
				  <div class="form-group">
                    ...
                    <select name="course" class="form-control select2" data-validate="required" data-message-required="<?php echo ucfirst('value_required');?>">
                        ...
                        <?php  foreach($course_data as $row){ ?>
                                          <option value="<?php echo $row->course;?>"><?= $row->course;?></option>
                                <?php } ?>  
                          </select>
                    </div> 
                  </div>
