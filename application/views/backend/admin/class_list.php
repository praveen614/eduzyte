...
<table>
    <tr>
        <td>
            <a href="<?=base_url()?>admin/admin/class_list/getClassList">Get ClassList</a>
        </td>
        <td>
            <a href="<?=base_url()?>admin/admin/class_list/schedule">Class Schedule</a>
        </td>
        <td>
            <a href="<?=base_url()?>admin/admin/class_list/removeclass">Remove Class</a>
        </td>

    </tr>
    <tr>
	    <td>
            <a href="<?=base_url()?>admin/admin/class_list/getDiscount">List Class Discount</a>
        </td>
        <td>
            <a href="<?=base_url()?>admin/admin/class_list/creatediscount">ADD Discount</a>
        </td>
        <td>
            <a href="<?=base_url()?>admin/admin/class_list/removediscount">Remove Discount</a>
        </td>
    </tr>
	<tr>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/getclassrecording">Get Class Recording</a>
		</td>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/getrecording">Get record</a>
		</td>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/changestatusrecording">Change Status of recording</a>
		</td>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/removeclassrecording">Remove Class Recording</a>
		</td>
	</tr>
	<tr>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/getprice">List Class Prices</a>
		</td>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/createprice">ADD price</a>
		</td>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/removeprice">Remove Price</a>
		</td>
	</tr>
	<tr>
		<td>
			<a href="<?=base_url()?>admin/admin/class_list/getlaunchurl">Get launch url</a>
		</td>
	</tr>
</table>
<?php }?>
...
require_once ('new_api.php'); 
 
$bc = new Braincert("0M1zj8t4kOZodQ0rqiON");
...
<?php if($form_name == 'getClassList'){ ?>
 ...
 <?php if($form_name == 'creatediscount'){
// echo date ('h:i:s');
 ?>
 <form class="form-horizontal form-validate" id="adminForm" method="post" enctype="multipart/form-data">
		<div class="control-group">
 ...
 <?php } ?>
  <?php if($form_name == 'removediscount'){ ?>
 <form class="form-horizontal form-validate" id="adminForm" method="post" enctype="multipart/form-data">
		<div class="control-group">
 ...
 <?php } ?>
  ...
  <?php if($form_name == 'getclassrecording'){ ?>
 <form class="form-horizontal form-validate" id="adminForm" method="post" enctype="multipart/form-data">
		<div class="control-group">
          	<label class="span1 hasTip" for="title"  title="Classroom id">class id:</label>
            <div class="controls">
 ...
 <?php } ?>
   <?php if($form_name == 'changestatusrecording'){ ?>
 <form class="form-horizontal form-validate" id="adminForm" method="post" enctype="multipart/form-data">
		<div class="control-group">
          	<label class="span1 hasTip" for="title"  title="Record id">Record id:</label>
            <div class="controls">
 ...
 <?php } ?>
   <?php if($form_name == 'removeclassrecording'){ ?>
 <form class="form-horizontal form-validate" id="adminForm" method="post" enctype="multipart/form-data">
		<div class="control-group">
          	<label class="span1 hasTip" for="title"  title="Record id">Record id:</label>
            <div class="controls">
