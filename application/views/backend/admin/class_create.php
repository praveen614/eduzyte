    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/admin/create_class_insert', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
                              ...
                              <?php for($i=0;$i<22;$i++){?>
                                <option value="<?=$i;?>:00" <?php if(isset($subjects_edit_data)){echo($subjects_edit_data->from_time == $i.':00')?'selected':'' ;} ?>><?=$i;?>:00</option>
                        <option value="<?=$i;?>:30" <?php if(isset($subjects_edit_data)){echo($subjects_edit_data->from_time == $i.':30')?'selected':'' ;} ?>><?=$i;?>:30</option>
                          <?php } ?>                                                                              
                          </select>
                                </div>
                                <div class="col-sm-6">
                              ...
                              <option value=""><?php echo 'To time';?></option>                                                                              
                          </select>
                                </div>
                                </div>
                            </div>
