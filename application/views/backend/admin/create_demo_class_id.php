    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/live_classes/create_demo_class_id', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">Recurring Class (optional) :</label>
                                <div class="col-sm-5">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">Repeat Class (optional) :</label>
                                <div class="col-sm-5">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">Select days (optional) :</label>
                                <div class="col-sm-5">
                                    <select name="weekdays[]" class="form-control select2" multiple>									
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">Class type (optional) :</label>
                                <div class="col-sm-5">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">Record Class  (optional) :</label>
                                <div class="col-sm-5">
