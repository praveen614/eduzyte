                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
									...
									<li>
                                          <a href="<?php echo base_url();?>admin/course_page/active_student_message/<?php echo $row->id;?>">
                                                <i class="entypo-pencil"></i>
															...
															<li class="divider"></li>
                                       <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_edit_student_message/<?=$row->id?>');" >
                                                <i class="entypo-pencil"></i>
                                                                              <?php echo 'Edit';?>
                                                </a>
                                                            </li>
                                       ...
                                       <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/course_page/student_message_delete/<?php echo $row->id;?>');">
