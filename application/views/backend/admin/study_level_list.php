            ...
            <a href="<?php echo base_url();?>admin/course_page/study_level/add" 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                          <a href="<?php echo base_url();?>admin/course_page/study_level/edit/<?php echo $row->id;?>" >
                          ...
                          <?php echo 'Edit';?>
                                       ...
                                       <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/course_page/study_level/delete/<?php echo $row->id;?>');">
