    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/course_page/levels/insert', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>

                        <div class="form-group">
                        <label for="field-2" class="col-sm-3 control-label"><?php echo 'Study Level';?></label>

                        <div class="col-sm-5">
                            <select name="study_level_id" id="study_level_id" class="form-control" value="" autofocus >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select name="level_heading_id" id="level_heading_id" class="form-control" value="" autofocus >
                              <option value=""><?php echo '--Select--';?></option>
                              <?php                                
                           ...
                           <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo 'Lower Levels';?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="levels" value="" data-validate="required" data-message-required="<?php echo ' required';?>" required autofocus />
                                </div>
                            </div>                                                     
