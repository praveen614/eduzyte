               ...
               <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $i;?></td>
                            <td><?php echo $this->db->where('id',$row->student_id)->get('student')->row()->name;?></td> 
                           <td><?= $this->db->where('id',$row->study_level_id	)->get('study_level')->row()->study_level ;?></td>
							...
							<?php $result=$this->Course_model->check_student_subject($row->id);if($result == 1){echo "<span style='color:red'>This subject already Exists</span>";}else{echo "<span style='color:green'>New Subject</span>";} ?>
								</td>
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_student_request_subject/<?=$row->id?>');" >
