<a href="<?php echo base_url();?>admin/course_page/student_message" 
              class="btn btn-primary pull-right">
                <i class="entypo-plus-circled"></i>
              <?php echo 'Student Messages';?>
                </a> 
               ...
               <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
							...
							<th><div><?php echo 'Message';?></div></th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
									...
									<li>
                                          <a href="<?php echo base_url();?>admin/course_page/active_tutor_message/<?php echo $row->id;?>">
                                                <i class="entypo-pencil"></i>
															...
															<li class="divider"></li>
                                       <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_edit_tutor_message/<?=$row->id?>');" >
                                                <i class="entypo-pencil"></i>
                                                                              <?php echo 'Edit';?>
                                                </a>
                                                            </li>
                                       ...
                                       <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/course_page/tutor_message_delete/<?php echo $row->id;?>');">
