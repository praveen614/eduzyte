                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                          <a href="<?php echo base_url();?>admin/course_page/tutor_request_degree/active/<?= $row->id;?>" >
                                        ...
                                        <!-- teacher EDITING LINK -->
                                        <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_request_degree/<?=$row->id?>');" >
                                       ...
                                       <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/course_page/tutor_request_degree/delete/<?php echo $row->id;?>');">
