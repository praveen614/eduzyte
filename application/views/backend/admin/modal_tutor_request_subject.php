<?php 
	$where['id'] = $param2;
	$request=$this->Course_model->edit_operation('tutor_request_subject',$where);
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'admin/course_page/add_tutor_subject', array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
