    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/cms_page/address_prof/update/'.$data->id, array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                 <input type="text" name="address_prof" class="form-control" data-validate="required" data-message-required="<?php echo 'required';?>" required  value="<?= $data->address_prof?>"/>                                
                                </div>
                            </div> 
