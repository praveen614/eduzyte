<a href="<?php echo base_url();?>admin/course_page/tutor_rating" 
              ...
              <td><?php if($row->admin_status==1){echo "<span class='label label-success'>Active</span>";}else{echo "<span class='label label-danger'>Inactive</span>";}?></td>
                  ...
                  <li>
                                          <a href="<?php echo base_url();?>admin/course_page/active_student_rating/<?php echo $row->id;?>">
                              ...
                              <li class="divider"></li>
                                       <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_edit_student_rating/<?=$row->id?>');" >
                                                <i class="entypo-pencil"></i>
                                                                              <?php echo 'Edit';?>
                                                </a>
                                                            </li>
                                       ...
                                       <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/course_page/student_rating_delete/<?php echo $row->id;?>');">
