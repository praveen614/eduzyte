<a href="<?php echo base_url();?>admin/admin/student_incomplete/" 
              class="btn btn-primary pull-right">
                <i class="entypo-plus-circled"></i>
              <?php echo 'Incomplete Students';?>
                </a> 
               ...
               <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th><div><?php echo 'View Details';?></div></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
              ...
              <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                      ...
                                      <!-- <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_student_information/<?=$row->id?>');" >
                                        ...
                                        <li class="divider"></li>
                                      <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/modal_student_subjects/<?=$row->id?>');" >
                                                <i class="entypo-pencil"></i>
                                                                              <?php echo 'Subjects Details';?>
                                                </a>
                                                            </li>-->
                                    <li>
                                          <a href="<?=base_url()?>admin/admin/student_details/<?=$row->id?>" target="_blank" >
                                                <i class="entypo-pencil"></i>
                                                                              <?php echo 'View';?>
                                                </a>
                                          </li>
                                          <li>
                                          <a href="<?php echo base_url();?>admin/admin/active_student/<?php echo $row->id;?>">
                                                <i class="entypo-pencil"></i>
                                                                              <?php if($row->admin_status==1){ echo 'Inactive';}else{echo 'Active';}?>
                                                </a>
                                                            </li> 
                                          <li>
                                          <a href="<?php echo base_url();?>admin/admin/block_student/<?php echo $row->id;?>">
                                                <i class="entypo-pencil"></i>
                                                                              <?php if($row->block_status==1){ echo 'Block';}else{echo 'Active';}?>
                                                </a>
                                                            </li>
															<li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/admin/delete_student/<?php echo $row->id;?>');">
