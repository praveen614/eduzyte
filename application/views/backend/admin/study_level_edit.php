    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content">
                        ...
                        <?php echo form_open(base_url() . 'admin/course_page/study_level/update/'.$data->id, array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                            

                            
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo 'study_level';?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="study_level" value="<?= $data->study_level ?>" data-validate="required" data-message-required="<?php echo 'required';?>" required autofocus />
                                </div>
                            </div>
