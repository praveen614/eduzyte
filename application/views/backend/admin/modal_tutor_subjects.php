<?php 
$data		=	$this->db->get_where('tutor_subjects' , array('tutor_id' => $param2) )->result();
?>
<h2>Tutor subject details</h2>
...
<table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>                            
							...
							<th><div><?php echo 'Level to Level';?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $this->db->where('id',$row->from_level)->get('from_level')->row()->from_level.' to '.$this->db->where('id',$row->to_level)->get('from_level')->row()->from_level;?></td>	
