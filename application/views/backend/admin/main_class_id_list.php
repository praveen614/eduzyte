<b>Total Classes:  <?=$data->total;?></b> <a href="<?php echo base_url();?>admin/live_classes/main_class_id/" 
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                       ...
                                       <li>
                                          <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/modal/popup/cancel_main_class/<?=$data[$i]->id?>');" >
                                        ...
                                        <li class="divider"></li>
                                        <li>
                                          <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/live_classes/remove_main_class/<?=$data[$i]->id?>');">
