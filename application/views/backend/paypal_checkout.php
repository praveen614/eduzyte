...
<div class="package-details">
    <strong><?php echo 'Student_name';?> | <?php echo $student_details->name;?></strong> <br>
    <strong><?php echo 'Due';?> | <?php echo $invoice_details->due;?></strong> <br>
    <?php echo 'Title';?> | <?php echo $invoice_details->title;?> <br>
    ...
    paypal.Button.render({
        ...
        onAuthorize: function(data, actions) {
            ...
            return actions.payment.execute().then(function() {
                ...
                $.ajax({
                   url: '<?php echo base_url().'index.php?'.$user_type.'/pay/paypal/'.$invoice_details->invoice_id;?>'
                }).done(function () {
                    window.location = '<?php echo base_url().'index.php/'.$user_type.'/'.'invoice/'.$student_details->student_id;?>';
                });
            });
        }
