...
<!--required for getting the stripe token-->
        ...
        <img src="<?php echo base_url('uploads/logo.png');?>" width="25%;"
            style="opacity: 0.05;">
            <form method="post"
              action="<?php echo base_url().'index.php/parents/pay/stripe/'.$invoice_details->invoice_id;?>">
              <input type="hidden" name="student_id" value="<?php echo $student_details->student_id; ?>">
              <label>
                  <div id="card-element" class="field is-empty"></div>
                  <span><span><?php echo 'Credit_/_debit_card';?></span></span>
              </label>
              <button type="submit">
                  <?php echo 'Pay';?> $<?php echo $invoice_details->due;?>
              </button>
              <div class="outcome">
              ...
              <div class="package-details">
                  ...
                  <?php echo 'Package';?> | <?php echo $invoice_details->title;?> <br>
              </div>
